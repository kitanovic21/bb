...
* [X](https://x.com/oracledotnet)
* [Email Newsletter Sign Up](https://go.oracle.com/LP=28277?elqCampaignId=124071&nsl=onetdev)

## New Features
* Deep Data Security Enhancements

## Bug Fixes in Oracle.ManagedDataAccess 23.26.300
* Bug 39532896 - ORACLEDATAREADER.GETCHARS RETURNS 0 EVEN IF DATA EXISTS
* Bug 39517778 - ORA-12570: TNS:PACKET READER FAILURE OBSERVED WHEN NNE IS ENABLED AND SDU SIZE IS NEGOTIATED TO A DIFFERENT VALUE THAN BEFORE
* Bug 39335726 - CONNECTION POOL IS NOT AGGRESSIVE IN DESTROYING CONNECTIONS WHEN CONNECTION CHECK IN/OUT ACTIVITY REDUCES
* Bug 39261432 - IMPROVE ORACLEDATAREADER.GETORDINAL PERFORMANCE
* Bug 37779775 - ORACLEBULKCOPY INSERT DOES NOT THROW ORA-01438 WHEN VALUE EXCEEDS PRECISION AND SCALE OF NUMBER COLUMN
